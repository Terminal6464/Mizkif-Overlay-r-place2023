...
// @name         Mizkif r/place
// @version      0.2.3
// @description  Template overlay for Mizkif.
...
if (window.top !== window.self) {
    window.addEventListener('load', () => {
        ...
        image.onload = () => {
            image.style = `display: block; position: absolute; left: 470px; top: 700px; width: ${image.width}px; height: ${image.height}px; image-rendering: pixelated; z-index: 1`;
        };
        ...
        function refresh(forceRefresh) {
            ...
            GM_xmlhttpRequest({
                method: 'GET',
                responseType: 'blob',
                url: `https://i.imgur.com/nZyHTtZ.png?i=${Date.now()}`,
                onload: function (response) {
                    ...
                    fr.onload = (e) => {
                        ...
                        image.style = 'display: none;width:10%;height:10%;';
